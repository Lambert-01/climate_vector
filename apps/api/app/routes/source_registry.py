...
_SOURCE_ENTRIES = [
    ...
    },
    {
        ...
        "name": "Prospective Aedes Field Surveillance",
        ...
        "record_count_source": "0",
        "date_range": "N/A",
        "supports": "Aedes presence/absence, abundance, effort-standardized indices, species confirmation",
        "cannot_prove": "N/A",
    ...
    {
        "source_id": "community_surveillance",
        "name": "Community Aedes Breeding-Site Reports",
        "domain": "Community surveillance",
        "raw_file": "Not yet collected",
        "raw_export": "Not yet collected",
        "processed_table": "community_reports database table",
        "source_type": "pilot_required",
        "record_count_source": "Database count",
        "date_range": "N/A",
        "supports": "Community verification queue, source-reduction workflow, participation MEL",
        "cannot_prove": "Mosquito species or dengue transmission without field/laboratory confirmation",
        "quality_limitations": "Requires consent, moderation, GPS review, training, and verification",
        "status": "workflow_ready",
        "required_for_validation": "Prospective consented reports during funded pilot",
    },
    {
        "source_id": "dengue_genomics",
        "name": "Dengue Mosquito-Pool Genomic Registry",
        "domain": "Genomic surveillance",
        "raw_file": "Not yet collected",
        "raw_export": "Not yet collected",
        "processed_table": "genomic_samples database table",
        "source_type": "pilot_required",
        "record_count_source": "Database count",
        "date_range": "N/A",
        "supports": "Sample custody, MinION workflow, dengue result, serotype, QC and accession tracking",
        "cannot_prove": "Dengue circulation until laboratory-reviewed results are available",
        "quality_limitations": "Requires validated laboratory SOPs, controls, confirmatory testing, ethics and genomic governance",
        "status": "workflow_ready",
        "required_for_validation": "Prospective mosquito pools and laboratory review",
    },
    {
        "source_id": "population_mobility",
        "name": "Population and Mobility Exposure",
        "domain": "Exposure context",
        "raw_file": "Not yet approved",
        "raw_export": "Not yet approved",
        "processed_table": "Not available",
        "source_type": "formal_access_required",
        "record_count_source": "0",
        "date_range": "N/A",
        "supports": "Population denominators, urban exposure, cross-border mobility context",
        "cannot_prove": "Individual movement or transmission chains",
        "quality_limitations": "Requires approved aggregate data, privacy review, and documented spatial resolution",
        "status": "formal_access_required",
        "required_for_validation": "NISR and approved mobility partner data",
    },
    {
        "source_id": "model_evaluation",
        "name": "Dengue Model Evaluation Registry",
        "domain": "Model governance",
        "raw_file": "Generated during pilot",
        "raw_export": "Generated during pilot",
        "processed_table": "model_evaluations database table",
        "source_type": "system_generated",
        "record_count_source": "Database count",
        "date_range": "N/A",
        "supports": "Versioned validation design, discrimination, calibration and lead-time evidence",
        "cannot_prove": "Performance before official outcomes and prospective observations are available",
        "quality_limitations": "Metrics require locked outcomes, temporal/spatial validation, and reviewer approval",
        "status": "workflow_ready",
        "required_for_validation": "Official dengue outcomes and sufficient prospective samples",
    },
    {
        "source_id": "mel_observations",
        "name": "Monitoring, Evaluation and Learning Evidence",
        "domain": "Implementation evidence",
        "raw_file": "Generated during pilot",
        "raw_export": "Generated during pilot",
        "processed_table": "mel_observations database table",
        "source_type": "pilot_required",
        "record_count_source": "Database count",
        "date_range": "N/A",
        "supports": "Baseline, monthly, midline and endline implementation measurement",
        "cannot_prove": "Health impact without comparator, approved outcomes, and evaluation design",
        "quality_limitations": "Targets must be approved after geography and baseline confirmation",
        "status": "workflow_ready",
        "required_for_validation": "Approved MEL framework and prospective observations",
    },
]
