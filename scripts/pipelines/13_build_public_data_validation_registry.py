...
def build_validation_rows() -> list[dict[str, str]]:
    ...
    return [
        ...
        },
        {
            ...
            "date_start": "",
            "date_end": "",
            "variables": "malaria, WASH, health system, environment and health indicators",
            "model_use": "proposal context and interpretation, not district mosquito outcome training",
            "limitation": "mostly national/contextual indicators; not row-level intervention data",
